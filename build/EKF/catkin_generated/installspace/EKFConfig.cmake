...
if("FALSE" STREQUAL "TRUE")
  set(EKF_SOURCE_PREFIX /home/husarion/final_project/src/EKF)
  set(EKF_DEVEL_PREFIX /home/husarion/final_project/devel)
  set(EKF_INSTALL_PREFIX "")
  set(EKF_PREFIX ${EKF_DEVEL_PREFIX})
else()
  set(EKF_SOURCE_PREFIX "")
  set(EKF_DEVEL_PREFIX "")
  set(EKF_INSTALL_PREFIX /home/husarion/final_project/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'EKF' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husarion/final_project/install/${idir}'.  ${_report}")
    endif()
